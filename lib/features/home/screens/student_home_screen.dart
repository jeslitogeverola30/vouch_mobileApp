...
class _StudentHomeScreenState extends State<StudentHomeScreen> {
  ...
  void initState() {
    ...
    final lastRefreshStr = prefs.getString('student_last_refresh_time');
    if (lastRefreshStr != null) {
      _lastRefreshTime = DateTime.tryParse(lastRefreshStr);
    }
    _dailyRefreshCount = prefs.getInt('student_daily_refresh_count') ?? 0;
    _currentDay = prefs.getString('student_current_day') ?? '';
    ...
    await prefs.setString('student_last_refresh_time', now.toIso8601String());
    await prefs.setInt('student_daily_refresh_count', _dailyRefreshCount);
    await prefs.setString('student_current_day', today);
