...
import '../domain/faculty_catalog.dart';
...
class _SignUpScreenState extends State<SignUpScreen> {
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              _buildDropdown(
                                ...
                                items: FacultyCatalog.faculties,
                                onChanged: (value) {
                                  setState(() {
  ...
  Future<void> _handleSignUp() async {
    ...
    final isSchoolIdValid = AuthValidators.isSchoolId(schoolId);
    if (!isSchoolIdValid) {
      ScaffoldMessenger.of(context).showSnackBar(
    ...
    final nameParts = AuthValidators.splitFullName(fullName);
